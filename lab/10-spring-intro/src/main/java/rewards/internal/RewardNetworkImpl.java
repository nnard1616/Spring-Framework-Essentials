...
public class RewardNetworkImpl implements RewardNetwork {
	...
	public RewardConfirmation rewardAccountFor(Dining dining) {
        ...
        Account theAccount                 = this.accountRepository.findByCreditCard(dining.getCreditCardNumber());
		Restaurant theRestaurant           = this.restaurantRepository.findByMerchantNumber(dining.getMerchantNumber());

		AccountContribution theContribution = theAccount.makeContribution(
				theRestaurant.calculateBenefitFor(theAccount, dining)
		);
		this.accountRepository.updateBeneficiaries(theAccount);

		return this.rewardRepository.confirmReward(theContribution, dining);
	}
}